			...
			<footer id="main-footer">
				...
				<div id="bottom-footer">
					...
					<div id="footer-copyright">
                       ...
                       <span class="alignright "><a href="http://wpdean.com/engross-wordpress-theme/" >Engross</a> Theme. <?php _e('Powered by ', 'engross'); ?><a rel="nofollow" href="http://wordpress.org/">WordPress.</a></span></p>
					   </div>
                    </div>
