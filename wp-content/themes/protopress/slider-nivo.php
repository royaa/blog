...
if ( get_theme_mod('protopress_main_slider_enable' ) && is_home() ) : 
	...
	$count_x = $count = get_theme_mod('protopress_main_slider_count');
		...
		<div class="container">
			<div class="slider-wrapper theme-default">
		            ...
		            for ( $i = 1; $i <= $count_x; $i++ ) :
						...
						$title = get_theme_mod('protopress_slide_title'.$i);
						$desc = get_theme_mod('protopress_slide_desc'.$i);
						$button = get_theme_mod('protopress_slide_CTA_button'.$i);
						$url = esc_url ( get_theme_mod('protopress_slide_url'.$i) );
