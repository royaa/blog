...
function protopress_scripts() {
	...
	wp_enqueue_style('protopress-title-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('protopress_title_font', 'Raleway') ) );
	
	wp_enqueue_style('protopress-body-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('protopress_body_font', 'Khula') ) );
